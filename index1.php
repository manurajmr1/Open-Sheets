...
Loading demo dependencies. They are used here only to enhance the examples on this page
 ...
 data1 = [
                                                    ...
                                                    ["Export plans", "- User should be able to export lesson(s) in a suitable format and import these lessons in other instances of ABC LMS in other locations.
Weeeee", 180, "=C2*20/100", "=C2*30/100", "=C2*25/100", "=SUM(C2:F2)", "=SUM(C2:F2)", '=IF(H2>80,"H",(IF(H2>8,"M","L")))'],
                                                    ...
                                                    ["Media player", "- User would like to play the video content that is stored locally in a server.
- The media player will let the user play/pause/seek a video that's available in the resource library or lesson.", 40, "=C9*20/100", "=C9*30/100", "=C9*25/100", "=SUM(C9:F9)", "=SUM(C9:F9)", '=IF(H9>80,"H",(IF(H9>8,"M","L")))'],
